...
namespace ProtoBuf.Serializers
{
    internal sealed class PropertyDecorator : ProtoDecoratorBase
    {
            ...
            out bool writeValue, bool nonPublic, bool allowInternal)
        {
            ...
            writeValue = tail.ReturnsValue && (GetShadowSetter(model, property) != null ||
                                               property.CanWrite &&
                                               Helpers.GetSetMethod(property, nonPublic, allowInternal) != null);
...
#if WINRT || COREFX
            MethodInfo method =
 Helpers.GetInstanceMethod(property.DeclaringType.GetTypeInfo(), "Set" + property.Name, new Type[] { property.PropertyType });
#else
...
#endif
            var method =
                Helpers.GetInstanceMethod(reflectedType, "Set" + property.Name, new[] { property.PropertyType });
#endif
