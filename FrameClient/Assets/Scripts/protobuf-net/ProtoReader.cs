...
namespace ProtoBuf
{
    ...
    public sealed class ProtoReader : IDisposable
    {
        ...
        private int depth, dataRemaining, ioIndex, available, blockEnd;
        ...
        internal static object ReadTypedObject(object value, int key, ProtoReader reader, Type type)
        {
            ...
            else if (type != null && reader.Model.TryDeserializeAuxiliaryType(reader, DataFormat.Default,
                         Serializer.ListItemTag, type, ref value, true, false, true, false))
            {
                // ok
            }
            else
