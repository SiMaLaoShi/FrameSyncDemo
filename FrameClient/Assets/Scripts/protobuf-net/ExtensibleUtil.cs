...
namespace ProtoBuf
{
        ...
        class ExtensibleUtil
    {
        ...
        {
            foreach (TValue value in GetExtendedValues(RuntimeTypeModel.Default, typeof(TValue), instance, tag, format,
                         singleton, allowDefinedTag)) yield return value;
        }
#endif
        /// <summary>
        ///     All this does is call GetExtendedValuesTyped with the correct type for "instance";
            ...
            DataFormat format, bool singleton, bool allowDefinedTag)
        {
            ...
            try
            {
                ...
                while (model.TryDeserializeAuxiliaryType(reader, format, tag, type, ref value, true, false, false,
                           false) && value != null)
                    if (!singleton)
                    {
#if FX11
