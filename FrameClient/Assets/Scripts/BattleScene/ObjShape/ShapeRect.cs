...
{
    [HideInInspector] public int halfWidth;

    [HideInInspector] public int halfHeight;
    ...
    private void OnDrawGizmos()
    {
        ...
        var _width = ToolMethod.Config2Render(halfWidthCon);
        var _heigh = ToolMethod.Config2Render(halfHeightCon);

        var topVec = new Vector3[4];
