...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : MonoBehaviour
    {
        ...
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(10f, 10f, 900f, 600f);
        ...
        private LuaWindow m_LuaWindow = new LuaWindow();
        ...
        private void Start()
        {
            ...
            RegisterDebuggerWindow("Lua", m_LuaWindow);
        ...
        private void OnGUI()
        {
            ...
            //m_WindowRect.width = System.Math.Min(m_WindowRect.width, Screen.width);
            //m_WindowRect.height = System.Math.Min(m_WindowRect.height, Screen.height);
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>日志工具</b>");
            }
            else
            {
                m_IconRect = GUILayout.Window(0, m_IconRect, DrawDebuggerWindowIcon, "<b>日志</b>");
            }
